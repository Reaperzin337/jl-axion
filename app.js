...
function icon(name) {
  const icons = {
    ...
    whatsapp: `
      <svg class="icon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <path d="M12 4.2c4.33 0 7.8 3.26 7.8 7.39 0 4.12-3.47 7.45-7.8 7.45-1.12 0-2.2-.22-3.14-.64L5.2 19.5l1.1-3.27c-.8-1.17-1.24-2.57-1.24-4.04 0-4.13 3.48-7.99 6.94-7.99Z" fill="currentColor" fill-opacity="0.12"/>
        <path d="M12 4.2c4.33 0 7.8 3.26 7.8 7.39 0 4.12-3.47 7.45-7.8 7.45-1.12 0-2.2-.22-3.14-.64L5.2 19.5l1.1-3.27c-.8-1.17-1.24-2.57-1.24-4.04 0-4.13 3.48-7.99 6.94-7.99Z" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/>
        <path d="M10.25 8.7c-.21-.46-.38-.47-.58-.48-.17-.01-.35-.01-.52-.01-.18 0-.48.08-.74.36-.26.28-.99.95-.99 2.32 0 1.37 1.01 2.69 1.15 2.87.14.17 1.98 3.04 4.87 4.13 2.39.9 2.88.72 3.39.67.52-.05 1.67-.68 1.9-1.34.23-.66.23-1.22.17-1.33-.06-.11-.24-.17-.51-.3-.26-.13-1.54-.76-1.77-.84-.23-.08-.4-.13-.58.14-.17.28-.65.86-.8 1.03-.15.17-.3.19-.56.06-.26-.13-1.08-.39-2.06-1.21-.77-.66-1.28-1.49-1.43-1.73-.15-.25-.02-.39.11-.53.13-.12.26-.29.39-.44.13-.16.17-.27.26-.45.08-.18.04-.33-.02-.46-.06-.13-.54-1.35-.74-1.8Z" fill="currentColor"/>
      </svg>
    `
  };
